...
{
    internal class CloudWatchLogSinkOld : PeriodicBatchingSink
    {
        ...
        public CloudWatchLogSinkOld(IAmazonCloudWatchLogs cloudWatchClient, CloudWatchSinkOptions options) : base(options.BatchSizeLimit, options.Period)
        {
